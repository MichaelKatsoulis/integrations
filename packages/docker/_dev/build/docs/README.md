...
The Docker module supports collection of metrics from Podman’s Docker-compatible API on Elastic Agent 8.16.2 or later versions. It has been tested on Linux and Mac with Podman Rest API v2.0.0 and above.
